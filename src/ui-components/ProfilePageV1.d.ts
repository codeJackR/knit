...
export declare type ProfilePageV1OverridesProps = {
    ProfilePageV1?: PrimitiveOverrideProps<FlexProps>;
...
export declare type ProfilePageV1Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: ProfilePageV1OverridesProps | undefined | null;
}>;
export default function ProfilePageV1(props: ProfilePageV1Props): React.ReactElement;
