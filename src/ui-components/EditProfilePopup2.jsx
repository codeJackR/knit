...
export default function EditProfilePopup2(props) {
          ...
          >
            <Button
              ...
              onClick={async() => {
                props.toggle();
                buttonOnClick();
                await saveImage(props.creator.id, props.coverPhoto, "CoverPhoto");
                await saveImage(props.creator.id, props.profilePhoto, "ProfilePhoto");
              }}
